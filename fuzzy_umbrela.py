...
if __name__ == '__main__':
    ...
    fuzzy_umbrela_functions.plotEnergies(DataBase,Atoms,SpinCh,ListOrbitals,fileName='./fileEnergy.html',opacity=0.5)
    fuzzy_umbrela_functions.plotBands(DataBase,Atoms,SpinCh,ListOrbitals,fileName='./file.html')
    fuzzy_umbrela_functions.plotBandsWeight(DataBase,Atoms,SpinCh,ListOrbitals,fileName='./fileBands.html')
